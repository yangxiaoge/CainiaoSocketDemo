...
//                    SocketAddress socketAddress = new InetSocketAddress("192.168.80.80", 7777);
    ...
    private boolean dealWithData(InputStream is) {
        ...
        try {
            ...
            System.arraycopy(temp, 0, buf, 0, count);

            //byte[] temp1 = new byte[4];
            /*String s = "0x" + buf[3];

            temp1[0] = (byte) Integer.parseInt(s);
            temp1[1] = (byte)Integer.parseInt("0x" + buf[2]);
            temp1[2] = (byte)Integer.parseInt("0x" + buf[1]);
            temp1[3] = (byte)Integer.parseInt("0x" + buf[0]);*/
            /*byte[] temp1 = new byte[4];
            temp1[0] = 0;
            temp[1] = 0;
            temp[2] = 0;
            temp[3] = 12;
            buf = temp1;
            int datalength = Integer.parseInt("0x" + buf[3] + buf[2] + buf[1] + buf[0]);*/
